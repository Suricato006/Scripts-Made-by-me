...
GUI = game:GetService("CoreGui"):FindFirstChild("STX_Nofitication")
function Nofitication:Notify(nofdebug, middledebug, all)
    ...
    ambientShadow.ImageColor3 = Color3.fromHex("6A85AF")
    ...
    Window.BackgroundColor3 = Color3.fromHex("ECF1FA")
    ...
    WindowTitle.BorderColor3 = Color3.fromHex("6A85AF")
    ...
    WindowTitle.TextColor3 = Color3.fromHex("6A85AF")
    ...
    WindowDescription.TextColor3 = Color3.fromHex("6A85AF")
    ...
    elseif SelectedType == "option" then
        ...
        Uncheck.ImageColor3 = Color3.fromHex("E981FF")

        Check.Name = "Check"
        Check.Parent = Window
        Check.BackgroundColor3 = Color3.fromHex(255, 255, 255)
        ...
        Check.ImageColor3 = Color3.fromHex("E981FF")
